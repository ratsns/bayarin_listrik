                                ...
                                <div class="col-lg">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4"><b><?= $judul ?></b><br>
                                                <small>Aplikasi Pembayaran Listrik</small></br>
                                            </h1>
                                        </div>
                                        <?= $this->session->flashdata('pesan'); ?>
                                        <form class="user" method="post" action="<?= base_url('pelanggan/register'); ?>">
                                            ...
                                            <div class="form-group mb-3">
                                                <input type="text" class="form-control form-control-user" value="<?= set_value('alamat'); ?>" id="alamat" placeholder="Alamat" name="alamat">
                                        ...
                                        <hr>
                                        <div class="text-center">
                                            <a class="small" href="<?= base_url('pelanggan'); ?>">Masuk</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
